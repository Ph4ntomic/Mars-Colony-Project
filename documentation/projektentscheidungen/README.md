...
In diesem Ordner werden wichtige Projektentscheidungen festgehalten, die für spätere Entwicklung, Dokumentation oder Abgabe relevant sind.

Neue Einträge sollten fortlaufend nummeriert werden:
