...
const SqlOverview: React.FC = () => {
    ...
    if (error) {
        return (
            <section className='p-8 text-center bg-secondary backdrop-blur-md rounded-xl border border-white/5 italic font-light tracking-wide'>
                <div className="flex w-full justify-center place-items-center gap-4">
